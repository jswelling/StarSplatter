...
class CircleSplatPainter : public SplatPainter {
 public:
  CircleSplatPainter(StarSplatter* owner_in);
  virtual ~CircleSplatPainter();
 ...
 private:
  inline void circlept(double xx,double yy,
		       const double sep_fac, 
